        ...
        <Container>
            <div className="fixed inset-0 bg-white bg-opacity-30 backdrop-blur-sm flex flex-col items-center justify-center">
                <div className="p-8 bg-white bg-opacity-80 rounded-lg shadow-lg text-center">
                    <h2 className="text-2xl font-bold text-gray-700 mb-4">𝗗𝗘𝗦𝗖𝗥𝗜𝗕𝗘 𝗬𝗢𝗨𝗥 𝗗𝗥𝗘𝗔𝗠 𝗗𝗘𝗦𝗧𝗜𝗡𝗔𝗧𝗜𝗢𝗡!</h2>
                    <div className="flex justify-center w-full max-w-xl">
                        <FaCamera
                            className={`text-[#46B0A9] self-center mr-3 cursor-pointer transition-transform duration-300 ${isCameraClicked ? 'scale-75' : 'scale-100'}`}
                            size={40}
