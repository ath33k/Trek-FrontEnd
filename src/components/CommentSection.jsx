...
const CommentSection = () => {
  const [comments, setComments] = useState([
    ...
    {
      id: 2,
      text: "Worth visiting this place. I love this place.",
      user: "User B",
    },
    {
      id: 3,
    ...
    // don't implement dummy data here, use props. add dummy data where the tag is used
  ]);
  ...
  const handleSend = () => {
    if (newComment.trim()) {
      ...
      setComments([
        ...comments,
        { id: nextId, text: newComment, user: "New User" },
      ]);
      setNewComment("");
    }
  };

  const commentsContainerClass = `space-y-4 ${
    comments.length > 5 ? "overflow-y-scroll" : "overflow-hidden"
  } max-h-60 max-w-md mx-auto`;
