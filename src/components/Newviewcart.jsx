...
export default function Newviewcard({ title, backgroundImage, width, height,description,rating,distance }) {
  const cardStyle = {
  ...
  return (
    <Container>
      <div>
        ...
        <p className='p-[10px] text-[18px] bg-gradient-to-r from-black to-transparent'>Here is the result what search</p>
        <div className=" absolute top-[620px] left-[40px] text-center w-[350px] rounded-[20px] translate-x-0 bg-[#ffffff0a] shadow-[35px_35px_35px_35px_rgba(0,0,0,0.3)]">
          ...
          <div className='flex h-[50px]'>
            ...
            <Rating/>
            <div className=' w-[80px] relative left-[170px] text-[25px]'>{distance} KM</div>
          </div>
