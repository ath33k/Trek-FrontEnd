...
export default function RatingComponent({ totalRating, reviewsCount, ratings }) {
      ...
      <div className="p-4 border border-gray-200 rounded-lg mb-10 ml-2 mr-2">
        ...
        <div className="flex gap-4 items-center">
          <div className="flex flex-col items-center">
            <span className="text-5xl font-bold text-green-600">{totalRating}</span>
            <span className="flex text-yellow-400 text-xl">{renderStars(totalRating)}</span>
        ...
        <div className="flex justify-center gap-2 mt-4">
          ...
          <button className="p-2 border border-gray-300 rounded text-gray-600">Warm</button>
          <button className="p-2 border border-gray-300 rounded text-gray-600">Hike</button>
          <button className="p-2 border border-gray-300 rounded text-gray-600">Treking</button>
          <button className="p-2 border border-gray-300 rounded text-gray-600">Beach</button>
          <button className="p-2 border border-gray-300 rounded text-gray-600">Cold</button>
        </div>
        {/* <div className="my-4 flex flex-col items-center justify-center">
        <p className="text-lg mb-2">How do you rate this place?</p>
        <div className={starSpacingStyle}><Rating
